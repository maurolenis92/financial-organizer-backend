...
router.post('/budgets', validate(createBudgetSchema), (req, res, next) =>
...
router.put('/budgets/:id', validate(updateBudgetFullSchema), (req, res) =>
  budgetController.updateFull(req, res)
);
