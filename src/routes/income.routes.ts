...
// Rutas de ingresos
router.post('/incomes', validate(createIncomeSchema), (req, res, next) =>
  incomeController.create(req, res, next)
);
router.get('/incomes/budget/:budgetId', (req, res, next) =>
  incomeController.getByBudget(req, res, next)
);
router.put('/incomes/:id', validate(updateIncomeSchema), (req, res, next) =>
